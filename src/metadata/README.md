 ...
 * [sudo.yml](sudo.yml)
     * Determines how your purl.obolibrary.org/obo/sudo/ redirects will be handled
     ...
     * Paste in the contents of [sudo.yml](sudo.yml)
 ...
 * [sudo.md](sudo.md)
     ...
     * Paste in the contents of [sudo.md](sudo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
